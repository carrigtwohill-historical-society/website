...
<h1>Families of Carrigtwohill</h1>
    ...
    <figure class="FigureRight">
        <img src="/assets/Persons%20of%20Note/Barry/Barrymore%20Cover.jpg" alt="ImageBarrymoreCover">
    </figure>
    <h2>Barry of Barrymore</h2>
    <h3>Barry of Carrigtwohill</h3>
    ...
    <p class="indentedText">
        The Standish Barry family is a branch of the original Catholic Barry family at Leamlara, Carrigtwohill. 
        Whereas the Smith Barry branch became Protestant who were bases predominantly at Marbury Hall, Cheshire, 
        England with a substantial estate at Foaty, today's Fota Island. Both branches are descended from the 
        Philip de Barri of Manorbier, Pembrokeshire, Wales.
    </p>
    <p class="indentedText">
        The third is of Dundellerick, north of Lisgoold, whose line did not adopt a double-barrel name format, fully 
        documented by Rev. Father Edmund Barry, P.P., Rathcormack.
    </p>
    <h3>Reverend Father Edmond Barry</h3>
    <p class="indentedText">
