...
<h1>Cotter of Anngrove & Rockforest</h1>
    <h2>Hanged Sir James Cotter</h2>
    <h3>Early Life</h3>
       
    <p class="indentedText">
        Sir James was raised a Catholic by his father's Protestant friend, John Galwey of Lota, M.P. for Cork City
        during King James’ Parliament. For this, charges were brought against him with the following entry recorded
        in the House of Commons’ Journal, 29<sup>th</sup> September 1707:
    </p>
    <p class="IndentQuotes">
        ...
        a minor, out of the custody of William Netterville, his Protestant guardian and marrying him to a daughter of 
    ...
    <p class="IndentQuotes">
        Ordered. That John Galwey be taken into the custody of the Serjeant-at-Arms attending this House.</p>
    <p class="IndentQuotes">
        Order. That the state of the case relating to the children of Sir James Cotter be printed. </p>
    <p class="indentedText">
        Thankfully for him, the orders were rescinded when John Galwey expressed his regret for his action and paid his
        fines, as recorded within the same journal, 2<sup>nd</sup> October 1707.
    </p>
    <p class="indentedText">
    ...
    <figure class="FigureLeft">
        <img src="/assets/Persons%20of%20Note/Cotter/James%20Cotter/Cotter%20case%20-%20Pue%27s%20Occurrences%20Dublin%203%20March%201719.jpg" alt="ImageCaseNotice">
        <figcaption>Pue's Occurrences of Dublin,<br />
            3<sup>rd</sup> March 1719 </figcaption>
    </figure>
    <p class="indentedText">
        Many accounts incorrectly state Sir James was, “<em>for his devotion to the cause of the Stuarts, executed the 7 May 1720</em>”. 
        This idea is repeated within Bernard Burke's, ‘<em>A General and Heraldic Directory of the Peerage and Baronetage of the British Empire</em>’,
        1865, claiming, “… <em>fell a victim to his devotion to the cause of the house of Stuart, and was executed</em>…” John Burke, 
        ...
        she repeatedly denied any attack had taken place. There may well have been political undertones in the background driving the case; for as governor of Cork, Sir James is said
        ...
        of Lisle’s participation in confiscating Quaker Charles 1<sup>st</sup> property for use as prisons. </p>
    
    
    
    <p class="indentedText">
        The Pue's Occurrences of Dublin published following notice, 3<sup>rd</sup> March 1719, here transcribed for ease of 
        reading;
    </p>
    <p class="IndentQuotes">
        ...
        stand tryal at the next assizes to be held for the City of Cork."</p>
    <p class="indentedText">
   ...
   <p class="indentedText">
       Then on the 26<sup>th</sup> May, the Caledonian Mercury included the following two statements from the condemned man on the day of his execution.
   </p>
        ...
        <tr>
            <td>
                <figure class="FigureCenter">
                    <img src="/assets/Persons%20of%20Note/Cotter/James%20Cotter/Caledonian%20Mercury%20Cover.jpg" alt="ImageCaledonianCover">
                </figure>
                
            </td>
            <td>
                <figure>
                    <img src="/assets/Persons%20of%20Note/Cotter/James%20Cotter/Caledonian%20Mercury%2027%20May%201720.jpg" alt="ImageCaledonianArticle">
                </figure>
            </td>
        </tr>
   ...
   <p class="indentedText">
       According to one unqualified source, Sir James Cotter was executed '<b><i>at the corner of Broad Lane</i></b>’, and is assumed
    ...
    <figure class="FigureCenter">
        <img src="/assets/Persons%20of%20Note/Cotter/James%20Cotter/Squib%20mobbed%20-%20Caledonian%2026%20May%201720.jpg" alt="ImageSquibMobbed">
  <figcaption>Caledonian Mercury - Edinburgh, Midlothian, 26<sup>th</sup> May 1720</figcaption>  
  </figure>
