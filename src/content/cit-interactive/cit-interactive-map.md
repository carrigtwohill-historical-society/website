...
<h1>Projects & Events</h1>
    ...
    <p class="indentedText">
        The base map used for our interactive map is an edited extract of the historic 25 inch map (1889-1913), and will be of particular relevance for those with an interest in the rich social and cultural history of Carrigtwohill.These were originally to be found on Ordnance Survey Ireland (OSI) mapping system generated by Geohive.ie (now defunct). They have in recent years been mover to the
        <a href="https://heritagedata.maps.arcgis.com/apps/webappviewer/index.html?id=0c9eb9575b544081b0d296436d8f60f8/" target="_blank">Historic Environment Viewer</a>. 
        Simply search Carrigtwohill and zoom after first selecting the 25 inch map.
