...
<h1>Religious of the Parish</h1>
   ...
   <h3>Kilcurfin & Templecurraheen</h3>
    ...
    <figure class="FigureCenter">
        <img src="/assets/Religious%20of%20Parish/BradyHistory.png" alt="ImageBradyHistory">
    <figcaption>Clerical & Parochial Records of Cork, Cloyne, and Ross, by Rev William Maziere Brady, D. D</figcaption>
    </figure>
    <p class="indentedText">
    ...
    <p class="indentedText">
        ...
        and published, 26<sup>th</sup> May 1820, reporting on the state of the so-called Establish Church created
    ...
    <h3>Carrigtwohill or Charruig Thuaithil</h3>
